...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion,num_channel, steps=4, multiplier=4, stem_multiplier=3, k=4
                 ):
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(num_channel, C_curr, 3, padding=1, bias=False),
